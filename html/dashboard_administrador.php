...
<body>
    ...
    <div class="container">
        <aside class="sidebar">
            <div class="profile">
                <img src="/imagenes/estadistica.foto.png" alt="Foto de Perfil" class="profile-pic">
                <h2>Admin</h2>
            </div>
            <nav class="nav">
                <ul>
                    <li><i class="fas fa-qrcode"></i>
                        <a href="#" id="principal">Inicio</a></li>
                    <li><i class="fas fa-link"></i>
                        <a href="#" id="vistas">Vistas</a></li>
                    <li><i class="fas fa-stream"></i>
                        <a href="#" id="registros">Estadisticas</a></li>
                    <li><i class="fas fa-calendar-week"></i>
                        <a href="#" id="solicitudes">Solicitudes de Proyectos</a></li>
                </ul>
            </nav>
        </aside>
