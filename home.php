...
<section class="full-width pageContent">
		<section class="full-width text-center" style="padding: 40px 0;">
			<h3 class="text-center tittles">Proyectos de los Alumnos</h3>
			<!-- Aquí es donde se insertará el contenido dinámico de PHP -->
			<?php
				...
				if (count($proyectos) > 0) {
				    foreach ($proyectos as $proyecto) {
				        ...
				        echo "<button type='submit' name='estado' value='Completado'>Completado</button>";
				        echo "</form>";
				        echo "</div>";
				    }
				} else {
