...
$isUserLoggedIn = isset($_SESSION['estudiante_id']);
$idUsuario = $isUserLoggedIn ? $_SESSION['estudiante_id'] : null;
$idAdmin = 1;

// Verificar si ya existe una conversación entre este usuario y este administrador
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['enviar'])) {
        ...
        $consulta = "UPDATE mensajes SET Mensaje = :mensaje WHERE ID_Mensaje = :mensajeId AND ID_Usuario=:idUsuario";
        $stmt = $conexion->prepare($consulta);
    ...
    <div id="contenedor">
        <div id="caja-chat">
            ...
            foreach ($mensajes as $mensaje) {
                ...
                $nombre = $isUser ? 'Yo' : 'Administrador';
